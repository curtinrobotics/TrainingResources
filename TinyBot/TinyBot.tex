...
There are many different components of a robot: the most important being the microcontroller (the
brain and nervous system), the motors (the legs), and any sensors (how the robot sees the world). \\
