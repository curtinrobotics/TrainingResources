...
\begin{itemize}
    \item Allow the robot to move at different speeds (HINT: research the function !analogWrite()!)
    \item Make a line following robot (HINT: requires a light sensor)
    \item Make a robot that bounces of walls or other objects in its way (HINT: requires an ultrasonic sensor)
\end{itemize}
