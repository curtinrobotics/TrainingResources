...
\newtcolorbox[auto counter,number within=section]{warningbox}[1][]{
  enhanced jigsaw,colback=white,colframe=orange,coltitle=orange,
...
\title{	
    ...
    {\huge TinyBot}\\ 	% title
    \vspace{12pt}
    {\large A Beginner's Guide to Robotics}\\  % subtitle
...
\begin{center}
  \includegraphics[width=0.7\textwidth]{tiny_bot_photo.jpg}
\end{center}
...
There are many different components of the average robot: the microcontroller (the
brain and nervous system), the actuators (e.g. motors), and any sensors (how the robot senses the world). \\

This guide will take you through building a simple robot dubbed ``TinyBot''. It has two wheels, a caster
wheel, a battery, an Arduino, and a breadboard.
...
\begin{tabularx}{\linewidth}{cccX}
    ...
    Arduino Uno & 1 & \$5-\$80 & Discussed further in \ref{sec:microcontroller}, a genuine Arduino will cost about \$80. Fortunately, Arduino clones can be bought online for as little as \$5. Ebay is a good starting point for finding an Uno. \\
    Small breadboard & 1 & \$8 & Can be found at Altonics or Jaycar. \\
    Micro N20 Motor & 2 & \$17.25 & Altronics or Jaycar. \\
    Dual H-Bridge & 1 & \$7 - \$16&   Altronics stocks both motor drivers and motor controllers, though they can also be found on eBay and sites such as \href{https://au.rs-online.com/web/}{RS components}. For this tutorial, only a \href{https://www.altronics.com.au/p/z2900-l293d-motor-drive-ic/}{basic H-bridge driver} is necessary (about \$7).\\
...
While additional sensors can be bought and integrated with TinyBot, this is not necessary for this tutorial.
...
\begin{itemize}
    \item Allow the robot to move at different speeds
    \begin{itemize}
      \item  (HINT: research the function \lstinline[]!analogWrite()!)
    \end{itemize}
    \item Make a line following robot
    \begin{itemize}
      \item (HINT: requires a light sensor)
    \end{itemize}
    \item Make a robot that bounces of walls or other objects in its way
    \begin{itemize}
      \item (HINT: requires an ultrasonic sensor) \\
    \end{itemize}
\end{itemize}

TinyBot has been designed so that sensors and additional functionality can be easily added,
adding components to a breadboard is fairly trivial. However, the programming aspect of these
extra challenging challenges is quite involved. Make sure to research existing libraries
to see how to use various sensors and actuators.
