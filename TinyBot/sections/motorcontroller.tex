...
\begin{center}[h]
    ...
    \begin{minipage}{0.5\textwidth}\vspcae{0pt}
        \includegraphics[width=\textwidth]{L293D-block-diagram.jpg}
        \captionof{subfigure}{Block Diagram for 20 Pin Chip}
        \label{fig:l293d-block-diagram}
        
    \end{minipage}
    \begin{minipage}{0.2\textwidth}\vspcae{0pt}
        
    \end{minipage}
    \begin{minipage}{0.3\textwidth}\vspcae{0pt}
        \centering
        \includegraphics[width=\textwidth]{L293D-pinout.jpg}
        \captionof{subfigure}{Pinout of 16 Pin Chip}
        \label{fig:l293d-pinout}
    \end{minipage}
    \captionof{figure}{Diagrams from the L293D datasheet}
    \label{fig:l293d}
\end{figure}
